...
public class DaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
  ...
  protected void additionalAuthenticationChecks(
    ...
    if (usernamePasswordAuthenticationToken.getCredentials() == null) {
      logger.warn(messages.getMessage(PROPERTY_CREDENTIALS_NOT_PROVIDED, BAD_CREDENTIALS));
      throw new BadCredentialsException(
          messages.getMessage(PROPERTY_CREDENTIALS_NOT_PROVIDED, BAD_CREDENTIALS));
    }
    ...
    if (!passwordEncoder.matches(presentedPassword, userDetails.getPassword())) {
      ...
      throw new BadCredentialsException(
          messages.getMessage(PROPERTY_CREDENTIALS_INCORRENT_PASSWORD, BAD_CREDENTIALS));
    }
  }
